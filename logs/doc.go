...
LoggerProvider from the github.com/dbdoyc/opentelemetry-logs-go package can be used as
a default.
...
*/
package logs // import "github.com/dbdoyc/opentelemetry-logs-go/logs"
